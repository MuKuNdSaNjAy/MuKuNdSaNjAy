...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:1E3264,100:14B8A6&height=190&section=header&text=Mukund%20Sanjay&fontSize=48&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=AI%20%2F%20ML%20Engineer%20%E2%80%94%20Applied%20LLM%20Systems&descAlignY=55&descSize=17" width="100%"/>
...
```text
Input (audio/text) → ASR/NLU → LLM reasoning (LangGraph agents)
                   → Domain mapping (SNOMED/ICD/FHIR)
                   → Structured write-back (OpenMRS/DB)
```
